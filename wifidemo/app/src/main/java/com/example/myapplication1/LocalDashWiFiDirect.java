...
//import org.drulabs.localdash.wifidirect.FileClientAsyncTask;
//import org.drulabs.localdash.wifidirect.FileServerAsyncTask;
...
//            Log.d("paras", "Client sending to "+groupOwnerAddress);
//            new FileClientAsyncTask().execute(groupOwnerAddress);
//            isConnectionInfoSent=true;
//        }
//        if(wifiP2pInfo.isGroupOwner){
//            Log.d("paras", "Server listening");
//            new FileServerAsyncTask().execute();
//            Toast.makeText(getApplicationContext(), "M Owner",Toast.LENGTH_LONG).show();
//        }
//    }
//
//    @Override
