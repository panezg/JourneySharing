...
public class DistributedMatching {
    ...
    private void addTestData() {
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Male", "Walking", "dublin city center", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        userInfo = new UserInfo("3-vishal", "vishal", "8982210173", "Male");
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Male", "Walking", "dublin castle", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Female", "Walking", "dublin city center", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Female", "Taxi", "dublin city center", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Male", "Taxi", "dublin city center", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Female", "Taxi", "TCD", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
        ...
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Female", "Walking", "TCD", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);

        userInfo = new UserInfo("15-frank", "frank", "101", "Male");
        journeyRequestInfo = new JourneyRequestInfo(userInfo, "Male", "Taxi", "TCD", true);
        journeyRequests.put(userInfo.getId(), journeyRequestInfo);
